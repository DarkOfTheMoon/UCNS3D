	...
	DO I=1,KMAXE
        ...
        IF (DG.EQ.1) THEN
            ...
            DO NGP = 1, IQP
                ...
                IF (I == 1) WRITE(500+N,*) 'DG_RHS_VOL_INTEGRAL', I, NGP, ILOCAL_RECON3(I)%DG_VOL_SOL(:,NGP), RHS(I)%VALDG
            END DO
        END IF
