...
!> This function calculates the mass matrix for the element VEXTX:  0.222771778206677       0.211518513967366    0.251802460004030      VEXTY:  0.439008694688869       0.400724462066210 0.421177226361005      XXC:  0.228697584059357      YYC:  0.420303461038695
    ...
    REAL,DIMENSION(2,3)::QP_TEST !XY, POINT
    REAL,DIMENSION(3,5)::TAYLOR_BASIS_TEST !N_QP, IDEGFREE
    REAL,DIMENSION(5,5)::MM_TEST !IDEGFREE, IDEGFREE
    REAL,DIMENSION(1,5,5)::INV_MM
    REAL,DIMENSION(5)::MM_TEST1 !IDEGFREE
    
    N_QP = 3; N_DIM = 2; N_DOFS = 5
...
!     write(400+N,*) QP_TEST(1,1),QP_TEST(2,1),QP_TEST(1,2),QP_TEST(2,2),QP_TEST(1,3),QP_TEST(2,3)
    ...
    VEXT(1,:) = (/ 0,0 /); VEXT(2,:) = (/ 1,0 /); VEXT(3,:) = (/ 0,1 /)
    CALL QUADRATURETRIANGLE(N,2)
    
    DELTA_XY = (/ 1./2, 1./2 /)
    
    DO I_QP = 1, N_QP
        TAYLOR_BASIS_TEST(I_QP,:) = TAYLOR_BASIS(QPOINTS(:,I_QP), XCYC, DELTA_XY, QPOINTS, QP_WEIGHT_TEST, N_QP, N_DIM, N_DOFS, CELL_VOLUME)
