...
!                     
                         DO INC=1,QQP
                            ...
                            BASIS_VECTOR = BASIS_REC2D(N,QP_ARRAY(I,INC)%X,QP_ARRAY(I,INC)%Y,IORDER,Iconsidered,IDEGFREE) 
                        ...
                        QQP=QP_Triangle
                            ...
                            DO INC=1,QQP
                               ...
                               POY(1) = QPOINTS(2,INC)
                                ...
                                BASIS_VECTOR = BASIS_REC2D(N,QP_ARRAY(I,COUNT_1)%X,QP_ARRAY(I,COUNT_1)%Y,IORDER,Iconsidered,IDEGFREE) 
